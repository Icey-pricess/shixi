<template>
  <div class="update-profile-page w-690">
    ...
    <upload action="/upload"
      ...
      @file-uploaded-success="onFileUploaded"
    >
...
import { ImageProps, ResponeseProps } from '../store'
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      if (cid) {
        store.dispatch('fetchOneColumn', cid)
      }
    })
    let imageId = ''
    ...
    const onFileUploaded = (rawData: ResponeseProps<ImageProps>) => {
      if (rawData.data._id) {
